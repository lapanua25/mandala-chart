...
export const Breadcrumbs: React.FC<BreadcrumbsProps> = ({ breadcrumbs, onNavigate }) => {
  return (
    <nav className="flex items-center justify-between space-x-2 p-4 pl-16 md:pl-4 bg-cellBg border-b border-border w-full top-0 z-10 sticky overflow-x-auto min-h-[56px]">
      ...
      <div className="text-xs font-semibold text-textSecondary bg-secondary px-3 py-1 rounded-full ml-auto flex-shrink-0">
